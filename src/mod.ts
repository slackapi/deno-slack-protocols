 ...
 */
const DontCrossTheStreamsProtocol = function (): Protocol {
...
const MessageBoundaryProtocol = function (args: string[]): Protocol {
  ...
  return {
    ...
    // TODO: if we override default console.error functionality (as below), then we also need to implement the `install()` and `uninstall()` methods here
    error: console.log,
